...
export default function AboutModal({ isOpen, onClose }: AboutModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-black border-2 border-green-400 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="border-b-2 border-green-400 p-4 bg-black">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold text-green-400 flex-1 pr-4">📚 ABOUT: THE SCIENCE OF PRODUCTIVE PROCRASTINATION</h2>
            <Button
              variant="outline"
              size="sm"
              onClick={onClose}
              className="border-red-400 text-red-400 hover:bg-red-900/20 flex-shrink-0 z-10"
            >
              ✕ Close
            </Button>
          </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-auto p-6 bg-black text-green-400">
          <h3 className="text-2xl font-bold mb-6 text-green-400">{sections[activeSection].title}</h3>
          {sections[activeSection].content}
        </div>

        {/* Footer */}
        <div className="border-t border-green-400 p-4 bg-black text-center text-green-600 text-sm">
